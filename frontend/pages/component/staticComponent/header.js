const Header = (appContent) => {
    ...
    const menus = ['홈', '검색',  'TODAY beta', '저장된 공고','TODAY s','TODAY b']
    const urls = ['/', '/task/tasksearch', '/todaytask/todaytask', '/usertask/usertask', '/todaytask/todaysajeontask', '/todaytask/todaybonetask']
